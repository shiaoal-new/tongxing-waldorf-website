...
export default function VideoItem({ video, className }) {
  ...
  // Embed URL with autoplay and mute enabled for better browser compatibility
  // Most browsers require muted autoplay to work
  const embedUrl = videoId ? `https://www.youtube-nocookie.com/embed/${videoId}?autoplay=1&mute=1` : videoUrl;
