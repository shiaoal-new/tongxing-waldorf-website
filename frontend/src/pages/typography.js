...
export default function TypographyPage({ page, pages, navigation }) {
    ...
    return (
        <Layout pages={pages} navigation={navigation} title={page.title || "Typography"} navbarPadding={!effectiveHeroData}>
            <Head>
                <title>{page.title || "Typography System"} | Tung-Hsin Waldorf</title>
            </Head>
...
export async function getStaticProps() {
    const page = getPageBySlug("typography") || null;
